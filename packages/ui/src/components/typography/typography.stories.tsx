...
export const Demo: StoryObj<typeof meta> = {
	render: () => (
		<div>
			...
			<T.p>
				The king thought long and hard, and finally came up with <T.a href="#1">a brilliant plan</T.a>: he would tax the
			...
			<T.p>The king's subjects were not amused. They grumbled and complained, but the king was firm:</T.p>
			<T.ul>
