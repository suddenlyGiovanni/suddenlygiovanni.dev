...
import { type BasicRecord, type OptionalRecord, PropertyBasic } from './open-graph-base'
import { type BookRecord, PropertyBook } from './open-graph-book'
import { PropertyImage } from './open-graph-image'
import { type MusicAlbumRecord, PropertyMusicAlbum } from './open-graph-music-album'
import { type MusicPlaylistRecord, PropertyMusicPlaylist } from './open-graph-music-playlist'
import {
  PropertyMusicRadioStation,
  type RadioStationRecord,
} from './open-graph-music-radio-station'
import { type MusicSongRecord, PropertyMusicSong } from './open-graph-music-song'
...
import { PropertyVideoEpisode, type VideoEpisodeRecord } from './open-graph-video-episode'
import { PropertyVideoMovie, type VideoMovieRecord } from './open-graph-video-movie'
import { PropertyVideoOther, type VideoOtherRecord } from './open-graph-video-other'
import { PropertyVideoTvShow, type VideoTvShowRecord } from './open-graph-video-tvshow'
