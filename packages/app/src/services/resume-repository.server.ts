...
import { type DecodingError, GithubService, type InvalidDataError } from './github-service.server.ts'
...
type GetResumeWithMetadata = (
	...
	ref?: string,
) => Effect.Effect<typeof ResumeWithMetadata.Type, DecodingError | InvalidDataError | ParseError | OctokitError, never>

export class ResumeRepository extends Effect.Service<ResumeRepository>()('app/services/ResumeRepository', {
	...
	effect: Effect.gen(function* () {
		 ...
		 */
		const getResumeWithMeta: GetResumeWithMetadata = Effect.fn('ResumeRepository.getResume')(ref => {
