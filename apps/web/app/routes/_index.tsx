...
export default function Index(): JSX.Element {
	return (
		<article className={cn('flex', 'w-full', 'flex-col', 'justify-start', 'font-comic')}>
			...
			<T.p>
				I am a self-taught <strong>software developer</strong>, a geek, and more generally a
				problem solver. I am also a young father of three and a committed husband.
			</T.p>
			<T.p>
				I was born in ☢️🌧 <strong>1986</strong> (you to do the math) and grew up in a small
				city by the 🌊 sea <strong>in the north-east of 🇮🇹 Italy</strong>.
			</T.p>

			<T.p>
				At the university, I <strong>📚 studied Modern History</strong>, but I never
				actually graduated. There I <strong>met the ❤️ love of my life</strong>, 👱🏻‍♀️ Morena,
				with whom I have been together ever since.
			</T.p>
			<T.p>
			...
			<T.p>
				<strong>Kids</strong> are the <strong>most amazing thing</strong> that had happened
				to me. They <strong>changed my life</strong>. They <strong>brought</strong> so much{' '}
			...
			<T.p>
				...
				<strong>life long learner</strong>. <strong>Reading</strong>,{' '}
				<strong>thinking</strong>, and <strong>testing</strong> what I have learned{' '}
				<strong>is one of my life's joy</strong>. Programming has managed to scratch this
				itch for me ever since I picked it up.
			</T.p>

			<T.p>
				<strong>TypeScript</strong> is my language of choice. It has shaped the way I think
				soo much soo that now I'm seeing types, signatures, and contracts flowing around
				even in dynamically typed languages.
			</T.p>
			<T.p>
				<strong>I'm language-curious</strong>; my gaze is set on the{' '}
				<strong>functional</strong> side of the <strong>language</strong> spectrum with the
				end goal of, one day, picking up Haskell.
			</T.p>
			<T.p>
				<strong>I</strong> try <strong>not</strong> to <strong>concern</strong> myself too
				much <strong>with this</strong> library <strong>or that framework</strong> since, as
				time has proven many times over, they tend to come and go as the hype wagon moves on
				to the next thing.
			</T.p>
			<T.p>
				<strong>
					Instead, I prefer to have a better understanding of the underlying building
					blocks
				</strong>
				, which tend to be more stable: the language, the data structures, and the design
				patterns that enable the creation of higher levels of abstractions.
			</T.p>

			<T.p>
				<strong>Making stuff is really fulfilling for me</strong>.{' '}
				<strong>I just happened to choose to use code to do so</strong>, but I could
				definitely see myself as a 🪓 carpenter, working with wood, or as a 🧑🏻‍🍳 chef
				preparing some elaborate recipe or...
			</T.p>
