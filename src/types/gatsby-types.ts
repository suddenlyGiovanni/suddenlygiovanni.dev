    ...
    readonly site: Maybe<
      Pick<Site, 'buildTime'> & {
        readonly siteMetadata: Maybe<
          Pick<
            SiteSiteMetadata,
            'siteUrl' | 'keywords' | 'siteLocale' | 'siteLanguage'
          > & {
            defaultTitle: SiteSiteMetadata['siteTitle']
            titleTemplate: SiteSiteMetadata['siteTitleTemplate']
            defaultDescription: SiteSiteMetadata['siteDescription']
            defaultImage: SiteSiteMetadata['siteImage']
          } & {
            readonly social: Maybe<
              Pick<SiteSiteMetadataSocial, 'twitterHandle'>
            >
    ...
    readonly post: Maybe<
      Pick<Mdx, 'body'> & {
        readonly fields: Maybe<
          ...
          >
        >
        readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'unlisted'>>
      }
    >
  }
