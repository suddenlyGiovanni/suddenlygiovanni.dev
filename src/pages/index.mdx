...
import { ReadLink, DateAndReadingTime } from '../components'
...
For any further information, please **refer to my <ReadLink to={linksMap.get("resume").urlPathFragment}>📑 résumé</ReadLink>**.
...
<ReadLink to={linksMap.get('blog').urlPathFragment}>&larr; back to my Blog</ReadLink>
