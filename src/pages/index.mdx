...
import { DateAndReadingTime, ReadLink } from '../components'
...
For any further information, please **refer to my <ReadLink to={navItemsMap.get("resume").urlPathFragment}>📑 résumé</ReadLink>**.
...
<ReadLink to={navItemsMap.get('blog').urlPathFragment}>&larr; back to my Blog</ReadLink>
