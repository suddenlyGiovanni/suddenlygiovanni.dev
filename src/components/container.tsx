...
export const Container: StyledComponent<'div',
  ...
  '$maxWidth' | '$noHorizontalPadding' | '$noVerticalPadding'> = styled.div.attrs((props: ContainerProps) => ({
  ...
  max-width: ${({ $maxWidth, $noHorizontalPadding }) => $maxWidth + ($noHorizontalPadding ? 0 : 80)}px;
